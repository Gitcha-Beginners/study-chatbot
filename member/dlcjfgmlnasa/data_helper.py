...
class PreDataProcessing(object):
    ...
    def make_data_set(self):
        ...
        # for i in range(self.total_sentence_number):
        #     print('encoder, decoder : {}, {}'.format(encoder_sentence_list[i], decoder_sentence_list[i]))
...
if __name__ == '__main__':
    ...
    encoder_input, decoder_input = predataprocessing.sentence_apply_padding_and_vector(['I am a boy'])